...
export class GameScene extends Phaser.Scene {
    constructor() {
        ...
        this.gameManager = new GameManager(this, this.world, this.objectManager);
        this.movementSystem = createMovementSystem();
        this.cleanupSystem = createCleanupSystem(0 - HIDDEN_BOUNDARY, width + HIDDEN_BOUNDARY, 0 - HIDDEN_BOUNDARY, height + HIDDEN_BOUNDARY, this.gameManager.onCleanup.bind(this.gameManager));
        this.gravitySystem = createGravitySystem();
        this.collisionSystem = createCollisionSystem(this.gameManager.onCollision.bind(this.gameManager));
        this.renderSystem = createRenderSystem(this, this.objectManager);
    }
    preload() {
