...
import { GravityFalloffType, HasGravity, } from 'shared/src/ecs/components/hasGravity';
...
export const createSupergiant = (world, x, y, radius) => {
...
export const createRandomSupergiant = (world) => {
