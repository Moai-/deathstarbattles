const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/game-app-kHfTKpLL.js","assets/other-vendor-CQiTX5cC.js","assets/phaser-core-UqVUGhlF.js","assets/phaser-extras-BGc8xhKk.js","assets/react-vendor-B52gqvOY.js"])))=>i.map(i=>d[i]);
import{r as o,j as e}from"./react-vendor-B52gqvOY.js";import{g as j,G as T,A as Q,O as Se,a as yt,l as nt,m as bt,c as jt,b as Et,p as Oe,B as Te,d as De,e as Pe,u as wt,r as St,f as vt,h as Ct,E as C,i as ue}from"./game-app-kHfTKpLL.js";import"./other-vendor-CQiTX5cC.js";import{c as g,F as kt,a as Mt,b as It,d as _t,e as Me,f as At,g as Be,G as Rt,h as Tt,r as Dt,S as Nt}from"./ui-vendor-ClbfLyMU.js";const Ie=t=>{const n=document.getElementById("game-container");n&&(t===void 0&&(document.fullscreenElement?Fe():We(n)),t===!0?We(n):Fe())},We=t=>{t.requestFullscreen?t.requestFullscreen():t.webkitRequestFullscreen?t.webkitRequestFullscreen():t.msRequestFullscreen&&t.msRequestFullscreen()},Fe=()=>{document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen?document.webkitExitFullscreen():document.msExitFullscreen&&document.msExitFullscreen()},Lt=g.div`
  position: absolute;
  inset: 0;
  z-index: 0;
...
`;g(rt)`
  text-align: left;
  margin-bottom: 10px;
`;const Xt="0.9.1",Vt={version:Xt};var I=(t=>(t[t.FIRST_START=0]="FIRST_START",t[t.MAIN_MENU=1]="MAIN_MENU",t[t.CONFIG_GAME=2]="CONFIG_GAME",t[t.INGAME=3]="INGAME",t[t.SCORESCREEN=4]="SCORESCREEN",t[t.EDITOR=5]="EDITOR",t))(I||{});const qt="modulepreload",Kt=function(t){return"/"+t},Ye={},ve=function(n,s,i){let r=Promise.resolve();if(s&&s.length>0){let a=function(x){return Promise.all(x.map(m=>Promise.resolve(m).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),p=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));r=a(s.map(x=>{if(x=Kt(x),x in Ye)return;Ye[x]=!0;const m=x.endsWith(".css"),u=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${x}"]${u}`))return;const h=document.createElement("link");if(h.rel=m?"stylesheet":qt,m||(h.as="script"),h.crossOrigin="",h.href=x,p&&h.setAttribute("nonce",p),document.head.appendChild(h),m)return new Promise((S,A)=>{h.addEventListener("load",S),h.addEventListener("error",()=>A(new Error(`Unable to preload CSS for ${x}`)))})}))}function l(a){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=a,window.dispatchEvent(c),!c.defaultPrevented)throw a}return r.then(a=>{for(const c of a||[])c.status==="rejected"&&l(c.reason);return n().catch(l)})};class Jt{constructor(){this.appPromise=null,this.loading=!0,this.loadCallback=()=>{}}async loadApp(){return this.loading&&console.time("App loaded in"),this.appPromise||(this.appPromise=(async()=>{await ve(()=>import("./phaser-core-UqVUGhlF.js"),[]),await ve(()=>import("./phaser-extras-BGc8xhKk.js"),[]);const n=await ve(()=>import("./game-app-kHfTKpLL.js").then(s=>s.j),__vite__mapDeps([0,1,2,3,4]));return this.loading&&(console.timeEnd("App loaded in"),this.loadCallback(),this.loadCallback=()=>{}),this.loading=!1,n.App})()),this.appPromise}setLoadCallback(n){this.loadCallback=n}async createGame(){return(await this.loadApp()).createGame()}async destroyGame(){return(await this.loadApp()).destroyGame()}async startMode(n,s){return(await this.loadApp()).startMode(n,s)}async stopMode(n){return(await this.loadApp()).stopMode(n)}}const z=new Jt,$e=[I.MAIN_MENU,I.CONFIG_GAME],lt=o.createContext(void 0),Zt=({children:t})=>{const[n,s]=o.useState(I.FIRST_START),[i,r]=o.useState(null),[l,a]=o.useState(null),[c,p]=o.useState(!0),x=async(m,u)=>{if($e.includes(m)||await z.stopMode(Q.BACKGROUND),m!==I.EDITOR&&await z.stopMode(Q.EDITOR),m!==I.INGAME&&(await z.stopMode(Q.GAME),j.off(T.GAME_END)),m===I.INGAME){const h=u||l;if(!h)throw new Error("Tried to start game without game config");j.on(T.GAME_END,S=>{const A=S[0];r(A),x(I.SCORESCREEN),j.off(T.GAME_END)}),a(h),z.startMode(Q.GAME,h)}m===I.EDITOR&&z.startMode(Q.EDITOR),$e.includes(m)&&(n===I.FIRST_START?z.createGame().then(()=>z.startMode(Q.BACKGROUND)):z.startMode(Q.BACKGROUND)),s(m)};return o.useEffect(()=>{n===I.FIRST_START&&(z.setLoadCallback(()=>{j.once(T.GAME_LOADED,()=>{p(!1)})}),x(I.MAIN_MENU))}),e.jsx(lt.Provider,{value:{isLoading:c,gameState:n,setGameState:x,winnerData:i,lastConfig:l},children:t})},ie=()=>{const t=o.useContext(lt);if(!t)throw new Error("useGameState must be used within GameStateProvider");return t},Qt=()=>{const[t,n]=o.useState(!0);return{setMute:i=>{n(i),j.emit(T.SET_VOLUME,{mute:i})},muted:t}},en=`
...
`,tn=()=>{const{setGameState:t}=ie(),{muted:n,setMute:s}=Qt(),[i,r]=o.useState(!1),l=n?It:_t,a=i?kt:Mt,c=()=>s(!n),p=()=>{const x=!i;r(x),Ie(x)};return i?e.jsx(st,{children:e.jsx(ee,{onClick:p,children:e.jsx(a,{})})}):e.jsxs(Ne,{style:{padding:"50px 0"},children:[e.jsx(Pt,{children:e.jsx(ee,{onClick:p,children:e.jsx(a,{})})}),e.jsx(Bt,{children:e.jsx(ee,{onClick:c,children:e.jsx(l,{})})}),e.jsx(ot,{children:"Death Star Battles"}),e.jsxs(rt,{children:["© 2001 Ian Bolland // © 2025 Sergei Gmyria // v.",Vt.version]}),e.jsx(Ue,{children:en}),e.jsxs(Ue,{children:[e.jsx("a",{href:"https://github.com/Moai-/deathstarbattles",target:"_blank",children:"Github Repo"})," | ",e.jsx("a",{href:"http://deathstarbattles.co.uk",target:"_blank",children:"Original Website"})]}),e.jsxs("div",{style:{display:"flex",gap:"10px"},children:[e.jsx(F,{onClick:()=>t(I.CONFIG_GAME),children:"New game"}),e.jsx(F,{onClick:()=>t(I.EDITOR),children:"Editor"})]})]})},nn=()=>{const[t,n]=o.useState(!1),[s,i]=o.useState(!1);return o.useLayoutEffect(()=>{const r=window.innerWidth,l=window.innerHeight;n(r>l),i(Math.min(r,l)<900)},[]),{isLandscape:t,isMobile:s}},sn=()=>{const{isMobile:t,isLandscape:n}=nn(),[s,i]=o.useState(90),[r,l]=o.useState(50),[a,c]=o.useState(!1),[p,x]=o.useState(!1),{setGameState:m}=ie();o.useEffect(()=>{p&&(x(!1),j.emit(T.ANGLE_POWER_UI,{angle:s,power:r}))},[p]),o.useEffect(()=>(j.on(T.ANGLE_POWER_GAME,({angle:b,power:v})=>{i(Math.trunc(b)),l(Math.trunc(v))}),j.on(T.OTHER_ACTION_GAME,b=>{b===Se.HYPERSPACE?c(!0):b||c(!1)}),()=>{j.off(T.ANGLE_POWER_GAME),j.off(T.OTHER_ACTION_GAME)}),[]);const u=(b,v,N,D)=>{b(k=>Math.min(D,Math.max(N,k+v))),x(!0)},h=b=>{i(b),j.emit(T.ANGLE_POWER_UI,{angle:b,power:r})},S=b=>{l(b),j.emit(T.ANGLE_POWER_UI,{angle:s,power:b})},A=()=>j.emit(T.END_TURN),E=()=>{a?(c(!1),j.emit(T.OTHER_ACTION_UI,Se.NONE)):(c(!0),j.emit(T.OTHER_ACTION_UI,Se.HYPERSPACE))},_=()=>{m(I.MAIN_MENU)};return t&&n?e.jsxs(e.Fragment,{children:[e.jsxs(zt,{children:[e.jsx(V,{children:e.jsx(xe,{onClick:_,children:e.jsx(Me,{size:15})})}),e.jsxs(V,{children:[e.jsxs(fe,{children:[s,"°"]}),e.jsx(X,{onClick:()=>u(i,1,-180,180),disabled:a,children:"+"})]}),e.jsx(ze,{children:e.jsx(he,{$isVertical:!0,min:-180,max:180,value:Math.floor(s),onChange:b=>h(Number(b.target.value)),disabled:a})}),e.jsx(V,{children:e.jsx(X,{onClick:()=>u(i,-1,-180,180),disabled:a,children:"-"})}),e.jsx(V,{children:e.jsx(xe,{onClick:A,children:e.jsx(At,{size:15})})})]}),e.jsxs(Ut,{children:[e.jsx(V,{children:e.jsx(xe,{onClick:()=>Ie(),children:e.jsx(Be,{size:15})})}),e.jsxs(V,{children:[e.jsxs(fe,{children:[r,"%"]}),e.jsx(X,{onClick:()=>u(l,-1,20,100),disabled:a,children:"-"})]}),e.jsx(ze,{children:e.jsx(he,{$isVertical:!0,min:20,max:100,value:Math.floor(r),onChange:b=>S(Number(b.target.value)),disabled:a})}),e.jsx(V,{children:e.jsx(X,{onClick:()=>u(l,1,20,100),disabled:a,children:"+"})}),e.jsx(V,{children:e.jsx(xe,{onClick:E,children:a?e.jsx(Rt,{size:15}):e.jsx(Tt,{size:15})})})]})]}):e.jsxs(Yt,{children:[e.jsx(pe,{children:e.jsx(He,{onClick:A,children:"End Turn"})}),e.jsx(pe,{children:e.jsxs(He,{onClick:E,children:["Hyperspace",a?" [On] ":" [Off]"]})}),e.jsxs(Ge,{children:[e.jsx(X,{onClick:()=>u(i,-1,-180,180),disabled:a,children:"-"}),e.jsx(he,{min:-180,max:180,value:Math.floor(s),onChange:b=>h(Number(b.target.value)),disabled:a}),e.jsx(X,{onClick:()=>u(i,1,-180,180),disabled:a,children:"+"}),e.jsxs(fe,{children:["Angle: ",s,"°"]})]}),e.jsxs(Ge,{children:[e.jsxs(fe,{children:["Power: ",r,"%"]}),e.jsx(X,{onClick:()=>u(l,-1,20,100),disabled:a,children:"-"}),e.jsx(he,{min:20,max:100,value:Math.floor(r),onChange:b=>S(Number(b.target.value)),disabled:a}),e.jsx(X,{onClick:()=>u(l,1,20,100),disabled:a,children:"+"})]}),e.jsx(pe,{children:e.jsx(ee,{onClick:()=>Ie(),children:e.jsx(Be,{})})}),e.jsx(pe,{children:e.jsx(ee,{onClick:_,children:e.jsx(Me,{})})})]})},on=t=>`#${t.toString(16).padStart(6,"0")}`,rn=()=>{const{setGameState:t,winnerData:n}=ie(),s=()=>{if(!n)return e.jsx("h1",{style:{color:"white"},children:"Nobody won! Total annihilation!"});const{playerId:i,col:r}=n;return e.jsxs("h1",{style:{color:on(r)},children:["Player ",i+1," wins!"]})};return e.jsx(Wt,{children:e.jsxs(Ft,{children:[s(),e.jsxs("div",{style:{display:"flex",gap:"10px"},children:[e.jsx(F,{onClick:()=>t(I.MAIN_MENU),children:"Menu"}),e.jsx(F,{onClick:()=>t(I.INGAME),children:"Play again"}),e.jsx(F,{onClick:()=>t(I.CONFIG_GAME),children:"Change settings"})]})]})})},U=g.div`
  display: flex;
  width: 100%;
  flex-direction: column;
  flex: 1;
...
`,Xe=["Tiny","Small","Large","That's no moon"],ln=[{label:"5",amount:5,isMax:!1},{label:"10",amount:10,isMax:!1},{label:"15",amount:15,isMax:!1},{label:"20",amount:20,isMax:!1},{label:"25",amount:25,isMax:!1},{label:"30",amount:30,isMax:!1},{label:"Up to 10",amount:10,isMax:!0},{label:"Up to 20",amount:20,isMax:!0},{label:"Up to 30",amount:30,isMax:!0}],Ve=[1,2,3,4],an=g.div`
  display: flex;
  width: 100%;
  gap: 0;
  margin-bottom: 16px;
